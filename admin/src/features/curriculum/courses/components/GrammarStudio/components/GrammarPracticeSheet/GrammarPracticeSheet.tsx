...
// ─── Adapter: GrammarQuestionCard → IQuestion ─────────────────────────────────

function toIQuestion(q: GrammarQuestionCard): IQuestion {
...
export const GrammarPracticeSheet = memo(function GrammarPracticeSheet({
    lessonId,
    questionIds,
    passingScore,
}: Props) {
        ...
        <Sheet>
            <SheetTrigger asChild>
                <Button
                    ...
                    aria-label="Làm thử bài tập ngữ pháp"
                >
