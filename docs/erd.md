# UniLish - ERD tinh gọn

Đây là mô hình dữ liệu logic sau khi loại bỏ các module không còn sử dụng: audit log, system setting, payment/transaction, coupon, course series, concept và user knowledge state.
...
- Các khóa ngoại thường xuyên được filter cần index: `languageId`, `learningGoalId`, `courseId`, `unitId`, `lessonId`, `userId`, `placementTestId`.
