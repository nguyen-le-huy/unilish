...
export function RegisterForm({
    ...
    const { register: registerUser, isLoading } = useTraditionalAuth()
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        >
                            <div className="flex h-20 w-20 items-center justify-center rounded-md">
                                <img src={UnilishLogo} alt="Unilish" className="h-20 w-20 dark:brightness-0 dark:invert" />
                            </div>
                            <span className="sr-only">Unilish</span>
                        </Link>
